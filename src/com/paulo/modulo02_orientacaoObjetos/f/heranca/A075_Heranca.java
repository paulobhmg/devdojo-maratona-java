package com.paulo.modulo02_orientacaoObjetos.f.heranca;

import com.paulo.modulo02_orientacaoObjetos.f.heranca.domain.Endereco;
import com.paulo.modulo02_orientacaoObjetos.f.heranca.domain.Funcionario;
